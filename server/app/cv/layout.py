...
600x400 のときの導出値は S8 以前の固定値と同一(塔バンド奥行きのみ S26 で拡大)
(塔x=150/300/450, 塔y=280, 待機y=80, 待機帯上限150, 塔バンド±70/±100)。
...
わずかに下回るが、塔間隔105mm・待機帯上限103.6mmで大箱75mmは収まる)。
"""
...
# 奥行き半幅は 0.25H(S26 で 0.2H から拡大)。実機では箱の推定位置が塔中心より約20mm
# 手前に出るうえ、特定の箱と角度の組合せで単面の姿勢推定がさらに30mm前後手前にずれることがあり、
# 0.2H では手前側マージン(A3で約37mm)が不足して塔判定が抜けた。
TOWER_HALF_Y_MM = _H * 0.25
