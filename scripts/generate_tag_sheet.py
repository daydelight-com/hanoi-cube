...
def build():
    ...
    w.text_block([
        ...
        (8, "・どの物理面を面1にするかは自由。ただし6枚の相対配置は次の規約に必ず従う"),
        (8, "  (3D表示が実箱の向き・面と連動するための前提。守らないと表示の面が食い違う):"),
        (8, "  1) 面1を上にして箱を置き、面2を手前(自分側)に決める。"),
        (8, "  2) 側面は 面2=手前, 面3=右, 面4=奥, 面5=左。図柄が正立する向きで貼る。"),
        (8, "  3) 面1は上面に、図柄の上端が奥(面4側)を向く向きで貼る。"),
        (8, "  4) 面6は箱を手前へ2回倒して底を上に向け、図柄の上端が奥を向く向きで貼る。"),
        (8, ""),
        (9, "■ サイズ別"),
